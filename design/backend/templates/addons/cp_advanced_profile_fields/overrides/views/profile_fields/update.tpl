...
<div class="cm-tabs-content">
    <div id="content_tab_new_profile{$id}">
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input id="elm_field_placeholder" class="input-large" type="text" name="field_data[placeholder]" value="{$field.placeholder}" />
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input id="elm_field_prompt" class="input-large" type="text" name="field_data[prompt]" value="{$field.prompt}" />
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input id="elm_field_maxlength" class="input-large" type="text" name="field_data[maxlength]" value="{$field.maxlength}" />
            </div>
        </div>
