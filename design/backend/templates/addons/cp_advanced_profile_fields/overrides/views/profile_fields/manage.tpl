    ...
    <form action="{""|fn_url}" method="post" name="fields_form" class="{$hide_inputs}" id="fields_form">
        ...
        <div class="table-responsive-wrapper longtap-selection" id="profile_fields">
            ...
            <table width="100%" class="table table-middle">
                    ...
                    <tbody id="section_fields_system" {if $is_deprecated}class="hidden"{/if}>
                        ...
                        >
                            ...
                            <td data-th="E-mail" width="{$description_col_width}%">
                                <a href="{"system_fields.update?sys_field_name=email"|fn_url}" data-ct-field-section="{$section}">E-mail</a>
                            </td>
                            <td class="nowrap" data-th="{__("type")}" width="{$type_col_width}%">
